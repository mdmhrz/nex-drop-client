...
export function Banner() {
    ...
    return (
        <section className="px-4">
            <div className="relative w-full overflow-hidden rounded-2xl max-w-7xl mx-auto shadow-lg border border-border dark:border-white/10">
                ...
                {/* ── Content row ── */}
                <div className="relative flex flex-col h-112 lg:h-128 sm:flex-row">
